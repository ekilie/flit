...
const recentActivity: ActivityItem[] = [
  {
    id: "1",
    type: "ride",
    message: "New ride completed: #R-1234",
    time: "2 minutes ago",
  },
  {
    id: "2",
  ...
  },
  {
    id: "3",
    type: "payment",
    message: "Payment processed: $45.00",
    time: "10 minutes ago",
  },
  {
    id: "4",
    type: "ride",
    message: "New ride started: #R-1235",
    time: "15 minutes ago",
  },
  {
    id: "5",
    type: "driver",
    message: "New driver registered: Jane Smith",
    time: "1 hour ago",
  },
]
    ...
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Weekly performance of rides and revenue
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Current status of all registered drivers
          </CardDescription>
        </CardHeader>
        <CardContent>
