              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3 my-8">
                    ...
                    <Button size="lg" variant="ghost" className="h-11 rounded-xl px-6 hover:text-[#98a75e]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-muted-foreground hover:text-[#98a75e] transition-colors">
