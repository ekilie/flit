            ...
            <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent dark:shadow-none dark:lg:bg-transparent">
              ...
              <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                ...
                <Button
                  ...
                  className={cn(
                    isScrolled
                      ? "lg:inline-flex bg-[#98a75e] hover:bg-[#98a75e]/90 text-black"
                      : "hidden bg-[#98a75e] hover:bg-[#98a75e]/90 text-black",
                  )}
                >
...
const CardDecorator = ({ children }: { children: React.ReactNode }) => (
  ...
  >
    ...
    <div className="bg-background absolute inset-0 m-auto flex size-12 items-center justify-center border-t border-l border-[#98a75e]">
      {children}
    </div>
  </div>
);
...
export default function FlitLanding() {
  ...
  return (
    <>
          ...
          <div className="relative pt-24 md:pt-36">
                ...
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm sm:text-xs">
                      Special Hire Vehicles At Your Service
                    </span>
                  ...
                  <h1 className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                    Your Ride,{" "}
                    <span className="inline-block text-[#98a75e] text-6xl md:text-7xl xl:text-[5.25rem] font-semibold">
                      On Demand
                    </span>
                  </h1>
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                    Experience the future of transportation with FLIT. Safe,
                    reliable, and comfortable rides at your fingertips. Book
                    your special hire vehicle in seconds.
                  </p>
                </AnimatedGroup>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                    <Button
                      size="lg"
                      variant="outline"
                      className="rounded-xl px-6 h-14 min-w-[200px] hover:bg-[#98a75e]/20 flex items-center gap-3 bg-transparent"
                    >
                      <svg
                        className="size-6"
                        viewBox="0 0 24 24"
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3 my-8">
                    <div className="bg-[#98a75e]/20 rounded-[14px] border border-[#98a75e]/30 p-0.5">
                      <Button
                        size="lg"
                        className="rounded-xl px-6 text-base bg-[#98a75e] hover:bg-[#98a75e]/90 text-black font-semibold"
                      >
                    ...
                    <Button
                      size="lg"
                      variant="ghost"
                      className="h-11 rounded-xl px-6 hover:text-[#98a75e]"
                    >
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                />
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border border-[#98a75e]/30 p-4 shadow-lg shadow-[#98a75e]/15 ring-1">
                  <div className="bg-gradient-to-br from-[#98a75e]/10 to-[#98a75e]/5 dark:from-[#98a75e]/20 dark:to-[#98a75e]/10 aspect-15/8 relative rounded-2xl border border-[#98a75e]/30 overflow-hidden">
          ...
          <div className="@container mx-auto max-w-5xl px-6">
            <div className="text-center">
              <h2 className="text-balance text-4xl font-semibold lg:text-5xl">
                Why Choose <span className="text-[#98a75e]">FLIT</span>
              </h2>
              <p className="mt-4 text-muted-foreground">
                Experience premium transportation with our special hire vehicle
                platform. Safe, reliable, and built for your comfort.
              </p>
            </div>
            <Card className="lg:max-w-full lg:grid-cols-3 lg:divide-x lg:divide-y-0 mx-auto mt-8 grid max-w-sm divide-y overflow-hidden shadow-zinc-950/5 border-[#98a75e]/30 *:text-center md:mt-16">
              <div className="group shadow-zinc-950/5">
                <CardHeader className="pb-3">
                  <CardDecorator>
                    <Clock className="size-6 text-[#98a75e]" aria-hidden />
                  </CardDecorator>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    24/7 service with drivers ready to pick you up anytime,
                    anywhere. Your ride is just a tap away.
                  </p>
                </CardContent>
              </div>
              ...
              <div className="group shadow-zinc-950/5">
                <CardHeader className="pb-3">
                  <CardDecorator>
                    <Shield className="size-6 text-[#98a75e]" aria-hidden />
                  </CardDecorator>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    All drivers are thoroughly vetted and vehicles are regularly
              ...
              <div className="group shadow-zinc-950/5">
                <CardHeader className="pb-3">
                  <CardDecorator>
                    <Zap className="size-6 text-[#98a75e]" aria-hidden />
                  </CardDecorator>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Book in seconds with our intuitive app. Track your driver in
                    real-time and pay seamlessly.
                  </p>
                </CardContent>
              </div>
            </Card>
      ...
      <footer className="bg-background border-t border-[#98a75e]/30">
        <div className="mx-auto max-w-7xl py-16 px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm text-muted-foreground max-w-xs">
                FLIT is your trusted special hire vehicle platform. Safe,
                reliable transportation whenever you need it.
              </p>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-muted-foreground hover:text-[#98a75e] transition-colors"
                >
                  <svg
                    className="h-5 w-5"
                    fill="currentColor"
          ...
          {/* Bottom section */}
          <div className="mt-12 pt-8 border-t border-[#98a75e]/30">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
              <div className="text-sm text-muted-foreground">
                © 2025 FLIT. All rights reserved.
              </div>
