...
function RidesPage() {
  ...
  const filteredRides = mockRides.filter((ride) =>
    ...
    ride.rider.toLowerCase().includes(searchQuery.toLowerCase())
  )
  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      <div className="flex items-center justify-between">
        ...
        <Link to="/console/rides/analytics">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent><div className="text-2xl font-bold">210</div></CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              {filteredRides.map((ride) => (
                <TableRow key={ride.id}>
                  ...
                  <TableCell className="text-right">
                    <Link to="/console/rides/$rideId" params={{ rideId: ride.id }}>
