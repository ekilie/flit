    ...
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent><div className="text-2xl font-bold">{mockRiders.length}</div></CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card>
          ...
          <CardContent><div className="text-2xl font-bold">$45,280</div></CardContent>
        </Card>
      </div>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem asChild>
                          <Link to="/console/riders/$riderId" params={{ riderId: rider.id }}>
